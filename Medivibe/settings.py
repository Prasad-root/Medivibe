"""
Django settings for Medivibe project.
...
SECRET_KEY = 'django-insecure-@t*buts0#%3=3j=o%)itoob_cat5xzc%z995ejqneckx@htftj'
...
WSGI_APPLICATION = 'Medivibe.wsgi.application'
